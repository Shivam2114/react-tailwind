...
<footer  className="relative z-10 text-white bg-gradient-to-l from-purple-700 to-blue-400  pt-20 pb-10 lg:pt-[120px] lg:pb-20">
    ...
    <div className="-mx-4 flex flex-wrap">
      ...
      <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
        <div className="mb-10 w-full">
          ...
          <p className="text-body-color text-base">&copy; 2023 IT Services</p>
        </div>
      </div>
    </div>
  </div>
